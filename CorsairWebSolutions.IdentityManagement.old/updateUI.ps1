iex ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/IdentityServer/CorsairWebSolutions.IdentityManagement.UI.AspNetIdentity/master/getmaster.ps1'))
