...
const settings: UserManagerSettings = {
  authority: 'http://localhost:9220',
  client_id: 'corsairwebsolutions',
  redirect_uri: 'http://localhost:21055/auth-callback',
  post_logout_redirect_uri: 'http://localhost:21055',
  response_type: 'id_token token',
  scope: 'openid profile corsairwebsolution_client',
  silent_redirect_uri: 'http://localhost:21055/auth-callback',
